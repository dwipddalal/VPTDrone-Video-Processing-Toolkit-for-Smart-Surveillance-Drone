...
class Normal_Loader(Dataset):
    ...
    """
    def __init__(self, is_train=1, path='/home/dwip.dalal/shoplifting_implementation_1/Real-world-Anomaly-Detection-in-Surveillance-Videos-pytorch/DATA/UCF-Crime/'):
        ...
        if self.is_train == 1:
            ...
            self.data_list = self.data_list[:-10] # since there are 150 videos in test_normalv2.txt whereas only 140 videos in test_anomalyv2.txt.
